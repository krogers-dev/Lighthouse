...
| yaml 2.9.0                                                                                         | Real YAML parsing for the Maestro flow validator (RETURN-3 area 8: a line scanner accepted malformed YAML) | No installed dependency parses YAML; hand-rolled parsing is exactly the rejected failure mode        | Dev-only                                                                                                                                                                                                                         |
