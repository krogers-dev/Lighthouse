...
| Hosted OTP email depends on template customization (Supabase June 3, 2026 change: new Free-tier default-provider projects cannot customize templates) | Release-blocking if unmet (sign-in emails would carry a link, not the six-digit token the app requires) | Recorded release dependency (PRODUCT.md): hosted staging/release require Pro or controlled custom SMTP, plus black-box proof the hosted email contains the OTP                                                                                                                                                                                                                                                                                                                                                                     |
